...
function setInCorso(cantInCorso) {
    ...
    for(let i=0; i<cantInCorso.length; i++){
        ...
        strCards += '<div class="card"><img class="card-img-top" src="../img/cantiere.jpg" alt="Card image cap"><button id="pennaPerEdit"><img class="pennaEditCantiere" src="../img/penna edit cantiere2.png" onclick="mostraInserimentoEdit('+cantiere.id+')"></button><div class="card-body"><p class="card-text">'+cantInCorso[i].nome+'</p></div></div>'
    }

...
function mostraAggiungiLavCant(){
    document.getElementById('listaLavDaAgg').style.visibility = "visible";
    document.getElementById('listaLavDaAgg').style.top = "0";
}

//Evento nel caso in cui venga premuto ESC durante l'inserimento del cantiere
window.addEventListener('keydown', function(e) {
    if(e.key == "Escape" && document.getElementById('listaLavDaAgg').style.visibility == "visible"){
        plusPremutoLavor = !plusPremutoLavor;
        document.getElementById('listaLavDaAgg').style.top = "150%";
        setTimeout(function(){
            document.getElementById('listaLavDaAgg').style.visibility = "hidden";
        }, 300);
    }
});
